  ...
  <div class="tags-view-container">
    <scroll-pane class='tags-view-wrapper' ref='scrollPane'>
      <div
        ...
        @click="handleToRefresh(tag, index)">
...
export default {
  ...
  methods: {
    ...
    handleToRefresh(tag, index) {
      this.$router.push({ path: tag.path, query: tag.query })
      this.$store.state.tagsView.active = index
      console.log('active-index:' + this.$store.state.tagsView.active)
    }
  }
}
</script>
